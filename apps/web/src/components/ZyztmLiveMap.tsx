...
const MAP_NODES: MapNode[] = [
  {
    ...
    left: '22%',
    stats: '356K Abos',
    detail: 'Neuestes Video auf YouTube · @FortniteNexusDE',
    live: true,
  },
  {
    id: 'tiktok',
    ...
    detail: 'Neuester Clip · 8,24% Engagement · @fortnitenexus',
    live: false,
  },
  {
    id: 'instagram',
    ...
    left: '70%',
    stats: 'Folge uns!',
    detail: 'Letztes Bild · @fortnitenexus',
    live: false,
  },
  {
    id: 'discord',
    ...
    detail: 'Community Hub · discord.gg/fortnitenexus',
    live: false,
  },
  {
    id: 'kick',
    ...
    top: '42%',
    left: '48%',
    stats: 'Community Content',
    detail: 'Content auf YouTube · @FortniteNexusDE',
    live: false,
  },
];
