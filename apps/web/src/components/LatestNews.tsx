...
const ALL_NEWS: NewsItem[] = [
  {
    ...
    teaser:
      'Das Lantern Festival 2026 ist zurück: Reload-Modus unterstützt erstmals Teams aus 8 Spielern (19.–25. Feb)! Schließe 12 exklusive Quests ab für bis zu 120.000 XP sowie die Free-Cosmetics "Bring It!"-Spray & "Love the Game"-Emoticon. Lantern Fest Cup am 3. März!',
    date: '19. Feb 2026',
    readTime: '3 min',
    icon: '🏮',
    url: 'https://www.fortnite.com/news/lantern-fest-2026-brings-8-player-reload-teams-to-fortnite',
  ...
  },
  {
    ...
    teaser:
      'Epic Games verschärft die Anti-Cheat-Anforderungen für Turniere ab 19. Feb 2026: Secure Boot, TPM 2.0 und IOMMU (VT-d/AMD-Vi) sind Pflicht für PC-Tournament-Play. Casual- und Ranked-Matches bleiben unberührt. Alle Details & Setup-Guide hier!',
    date: '19. Feb 2026',
    readTime: '5 min',
    icon: '🛡️',
    url: 'https://gamerant.com/fortnite-anti-cheat-changes-secure-boot-requirement/',
  ...
  },
  {
    ...
    teaser:
      'Love & Legends 2026: Sammle Candy Hearts in Team-Modi für das exklusive Heartie Back Bling! Logge dich 10 Tage ein für den "Sweetest Shot" Loading Screen. KPop Demon Hunters Wave 2 (Jinu, Golden Mira & Zoey) und Power Hours am 7., 14. & 21. Feb!',
    date: '5. Feb 2026',
    readTime: '4 min',
    icon: '💘',
    url: 'https://www.fortnite.com/news/love-and-legends-meet-in-fortnite-for-a-month-full-of-rewards',
  ...
  },
  {
    ...
    teaser:
      'Pop-Ikone Chappell Roan startet als Icon von Festival Season 13 (ab 5. Feb)! Heartcore Music Pass mit Pink-Touring-Outfit, Roan-of-Arc-Skin, Pink Pony Sidekick & Tracks wie "Pink Pony Club", "HOT TO GO!" und "Good Luck, Babe!" – Midwest Princess rides into Fortnite!',
    date: '5. Feb 2026',
    readTime: '4 min',
    icon: '🎤',
    url: 'https://www.fortnite.com/news/chappell-roan-the-midwest-princess-rides-into-fortnite-festival',
  ...
  },
  {
    ...
    tag: 'PATCH',
    tagColor: NEON_GREEN,
    title: 'V39.50 UPDATE – LANTERN FEST, SOLO LEVELING & MORE',
    teaser:
      'v39.50 ist live (19. Feb): Lantern Fest 8-Player Reload, Solo Leveling Collab (Sung Jin-woo, Cha Hae-in, Igris), DeLorean unvaulted, Story Quests mit The Seven & Dark Voyager. Dazu: Creative Mode Animation Tools & zahlreiche Balancing-Fixes!',
    date: '19. Feb 2026',
    readTime: '6 min',
    icon: '⚡',
    url: 'https://fortnitetracker.com/article/2415/fortnite-39-50-update-all-you-need-to-know',
  ...
  },
  {
    ...
    teaser:
      'Datamine-Leaks enthüllen: Chapter 7 Season 2 startet 19. März 2026 mit Norse Mythology Theme! Overwatch-Collab (Tracer, D.Va, Genji, Mercy) bestätigt, Looney Tunes (Bugs Bunny) im Battle Pass, neues Waffenpool & Midgard/Asgard-POIs. Season läuft bis 30. Apr!',
    date: 'März 2026',
    readTime: '7 min',
    icon: '🔮',
    url: 'https://www.dexerto.com/fortnite/fortnite-chapter-7-season-2-3298857/',
...
const EXTRA_NEWS: NewsItem[] = [
  {
    ...
    tag: 'EVENT',
    tagColor: NEON_GOLD,
    title: 'ARMORED TRAIN HEIST – VAULT KNACKEN FÜR MYTHIC LOOT',
    teaser:
      'Der gepanzerte Zug durchquert die Map in festen Intervallen (Crime City → Brutal Boxcarts → Seaport City). Zerstöre die Dachturrets für Thermite, sprenge den Vault und sichere dir 2 High-Tier-Truhen + Dill Bits! NPC-Guards spawnen nach dem Öffnen.',
    date: '21. Feb 2026',
    readTime: '4 min',
    icon: '🚂',
    url: 'https://www.dexerto.com/fortnite/how-to-hijack-train-vaults-in-fortnite-chapter-6-season-2-3140378/',
  ...
  },
  {
    ...
    teaser:
      'Spike Spiegel & Faye Valentine landen mit ikonischem Cel-Shading-Look in Fortnite! Bebop-Quests laufen bis 18. März 2026 – Belohnungen: exklusiver Wrap & Bebop Legends Loading Screen. Authentische Bebop-Accessories im Item Shop verfügbar!',
    date: '28. Feb 2026',
    readTime: '3 min',
    icon: '🚀',
