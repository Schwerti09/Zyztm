  ...
  switch (type) {
    case 'pro': {
      ...
      return {
        ...
        tweetText: `${pro.name} Fortnite Settings: ${pro.sensitivity.xAxis} Sens | ${pro.sensitivity.dpi} DPI | ${pro.sensitivity.cm360} cm/360\u00b0 \u2014 via Fortnite Nexus! `,
    ...
    case 'weapon': {
      ...
      return {
        ...
        tweetText: `${weapon.name}: ${weapon.damage} DMG | ${weapon.dps.toFixed(0)} DPS | ${weapon.tier}-Tier \u2014 via Fortnite Nexus! `,
    ...
    case 'sensitivity':
      return {
        ...
        tweetText: 'Meine Fortnite Sensitivity \u2014 konvertiert mit Fortnite Nexus! ',
    ...
    case 'loadout':
      return {
        ...
        ogImage: `${DOMAIN}/og/og-tools.png`,
        tweetText: 'Mein optimiertes Fortnite Loadout \u2014 via Fortnite Nexus! ',
        ctaLabel: 'Mach deins selbst',
    ...
    case 'stats':
      return {
        ...
        ogImage: `${DOMAIN}/og/og-tools.png`,
        tweetText: 'Meine Fortnite Stats \u2014 analysiert mit Fortnite Nexus! ',
        ctaLabel: 'Mach deins selbst',
