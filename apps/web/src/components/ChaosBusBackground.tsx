...
const CHUTE_COUNT = 6;
const CHUTE_STAGGER_DELAY_MS = 280;
const CHUTE_ANIMATION_DURATION_MS = 3200;
const CHUTE_CLEANUP_BUFFER_MS = 600;
const CHUTE_CLEANUP_DELAY_MS = CHUTE_ANIMATION_DURATION_MS + CHUTE_CLEANUP_BUFFER_MS;
...
function spawnParachuter(busEl: HTMLElement): void {
  ...
  setTimeout(() => el.remove(), CHUTE_CLEANUP_DELAY_MS);
}
